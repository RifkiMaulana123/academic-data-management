...
<?php
  ...
  if (isset($_POST['Submit'])){
    ...
    $result = mysqli_query($connection, "INSERT INTO mahasiswa(nrp,nama,jenis_kelamin,alamat,tanggal_lahir,id_program_studi) VALUES ('$nrp','$nama','$jenis_kelamin','$alamat','$tanggal_lahir','$id_program_studi')");
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_mahasiswa.php" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group">
                ...
                <input class="form-check-input" name="jenis_kelamin" type="radio" value="Laki-laki" checked>
               ...
               <div>
                ...
                <select name="id_program_studi" class="form-control"> 
                    ...
                    while($data_program_studi = mysqli_fetch_array($result_program_studi))
                        {
                    echo "<option value=".$data_program_studi['id_program_studi'].">".$data_program_studi
