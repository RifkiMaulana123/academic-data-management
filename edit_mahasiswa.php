...
<body id ="page-top">
  ...
  if(isset($_POST['update'])){
    ...
    $result = mysqli_query($connection, "UPDATE mahasiswa SET nrp = '$nrp', nama = '$nama', alamat = '$alamat', prodi = '$prodi' WHERE nrp = '$nrp'");
  ...
  <?php
  //Display selected dosen based on nrp
  $nrp = $_GET['nrp'];

  //Fetch data user based on id
  $result_mahasiswa = mysqli_query($connection, "SELECT * FROM mahasiswa WHERE nrp = '$nrp'");
          ...
          <form action="edit_mahasiswa.php" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" name="prodi" type="text" value="<?php echo $prodi; ?>" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
