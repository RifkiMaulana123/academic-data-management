                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdoxwn" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <img class="img-fluid" src="img/graduate.png" alt="">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal4">
            ...
            <img class="img-fluid" src="img/desk.png" alt="">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal6">
            ...
            <img class="img-fluid" src="img/file.png" alt="">
          </div>
        </div>
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_mahasiswa = mysqli_fetch_array($result_mahasiswa)) {
                        ...
                        echo "<td> <a class='btn btn-success' href='edit_mahasiswa.php?nip=$data_mahasiswa[nrp]'>Edit</a> <a class='btn btn-danger' onclick='deleteConfirm(event)' href='delete_mahasiswa.php?nrp=$data_mahasiswa[nrp]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
